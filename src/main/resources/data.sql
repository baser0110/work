...
CREATE TABLE profile (
                         ...
                         packet_loss_inspector permission NOT NULL DEFAULT 'NO',
...
ALTER TABLE profile ALTER COLUMN packet_loss_inspector TYPE VARCHAR;
ALTER TABLE profile ALTER COLUMN user_mng TYPE VARCHAR;
ALTER TABLE profile ALTER COLUMN vasily_tools TYPE VARCHAR;

-- ALTER TABLE profile ALTER COLUMN ext_alarm_mng TYPE permission USING ext_alarm_mng::permission;
-- ALTER TABLE profile ALTER COLUMN cell_stat_mng_single TYPE permission USING cell_stat_mng_single::permission;
-- ALTER TABLE profile ALTER COLUMN cell_stat_mng_batch TYPE permission USING cell_stat_mng_batch::permission;
-- ALTER TABLE profile ALTER COLUMN accept_measurement TYPE permission USING accept_measurement::permission;
-- ALTER TABLE profile ALTER COLUMN packet_loss_inspector TYPE permission USING packet_loss_inspector::permission;
-- ALTER TABLE profile ALTER COLUMN user_mng TYPE permission USING user_mng::permission;
-- ALTER TABLE profile ALTER COLUMN vasily_tools TYPE permission USING vasily_tools::permission;


-- Insert Profiles
INSERT INTO profile (id, name, ext_alarm_mng, cell_stat_mng_single, cell_stat_mng_batch, accept_measurement, packet_loss_inspector, user_mng, vasily_tools)
VALUES (gen_random_uuid(), 'bss_team', 'FULL', 'FULL', 'FULL', 'FULL', 'FULL','FULL', 'FULL');
--
...
-- ALTER TABLE app_user ADD COLUMN is_first_login  BOOLEAN NOT NULL DEFAULT True;
