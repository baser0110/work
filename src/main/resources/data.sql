...
VALUES (gen_random_uuid(), 'Administrator', 'FULL', 'FULL', 'FULL', 'FULL', 'FULL', 'FULL');
...
VALUES (gen_random_uuid(), 'admin', 'password123', false, (SELECT id FROM profile WHERE name = 'Administrator'));
