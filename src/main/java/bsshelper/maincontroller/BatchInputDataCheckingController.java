...
public class BatchInputDataCheckingController {
    ...
    public String cellStatusBatch(String separator, String umts, String gsm, String nbiot, Model model, HttpSession session) {
        ...
        model.addAttribute("OK", new ArrayList<>(List.of(umtsOkCount, gsmOkCount, nbiotOkCount)));
        model.addAttribute("NOK", new ArrayList<>(List.of(umtsFailCells.toString(), gsmFailCells.toString(), nbiotFailCells.toString())));
